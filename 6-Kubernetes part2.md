...
#### Cкриншот результата выполнения команды `kubectl get po -n kube-system`:

![Задание 1](https://github.com/user-attachments/assets/4ae0b7d1-57df-4075-9494-50f837677a90)
